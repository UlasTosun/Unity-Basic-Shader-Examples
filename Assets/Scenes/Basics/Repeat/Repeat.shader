    ...
    SubShader {
        ...
        Pass {
            ...
            half4 frag (v2f IN) : SV_Target {
                ...
                float2 uvFractal = frac(IN.uv * _Count);
                float len = length(uvFractal - _Center);
                float stepCol = smoothstep(len - _Smoothness, len + _Smoothness, _Radius);
                return texCol * stepCol;
            }
