Shader "My Shaders/Ambient Color" {



    Properties {
        _MainTex ("Texture", 2D) = "white" {}
        _Ambient ("Ambient Color Strength", Range(0, 1)) = 1
    }
    ...
    SubShader {
        ...
        Pass {
            ...
            half4 frag (v2f IN) : SV_Target {
                ...
                half3 ambientColor = _GlossyEnvironmentColor.rgb * _Ambient; // Calculate the ambient color.
                texCol.rgb += ambientColor; // Multiply the texture color by the ambient color.
